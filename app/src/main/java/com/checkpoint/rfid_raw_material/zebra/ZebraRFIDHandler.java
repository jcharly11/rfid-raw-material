...
class ZebraRFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    void onCreate(Context _context,int maxPower,String nameDevice,String session) {
        this.context = _context;
        this.MAX_POWER=maxPower;
        this.readername = nameDevice;
    ...
    private void ConfigureReaderToRead() {
        ...
        if (reader.isConnected()) {
            ...
            try {
                ...
                int []value =  reader.ReaderCapabilities.getTransmitPowerLevelValues();
                for (int x = 0; x<= value.length-1; x++) {
                    Log.e("---->",""+value[x]);
                }

                Antennas.AntennaRfConfig config = reader.Config.Antennas.getAntennaRfConfig(1);
                config.setTransmitPowerIndex(240);
    ...
    synchronized private void writeTag(String sourceEPC, String Password, MEMORY_BANK memory_bank, String targetData, int offset) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("EXCEPTION", e.getVendorMessage().toString());
            Log.e("RESULTS", e.getResults().toString());
            Log.e("RESULTS", e.getStatusDescription().toString());
    ...
    public class EventHandler implements RfidEventsListener {
        ...
        public void eventStatusNotify(RfidStatusEvents rfidStatusEvents) {
            ...
            if( rfidStatusEvents.StatusEventData.getStatusEventType() == STATUS_EVENT_TYPE.BATTERY_EVENT ){
                ...
                Log.e("BatteryData", String.valueOf(batteryData.getLevel()));
                batteryHandlerInterface.batteryLevel(batteryData.getLevel());
            }
        }
    }
