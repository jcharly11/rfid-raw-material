...
class CustomDialogProvider(private val activityBarCode: BarCodeActivity, context: Context): Dialog(context) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialogClickButton = activityBarCode
        ...
        btnSaveProvider.setOnClickListener{
            ...
            val idProvider =   tvIdProvider!!.text.toString()
            val idASProvider = tvIdASProvider!!.text.toString()
            val nameProvider = tvNameProvider!!.text.toString()

            dialogClickButton.saveProvider(idProvider,idASProvider,nameProvider)
        }
